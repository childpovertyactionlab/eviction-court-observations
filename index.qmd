...
**Between
`r format(min(as.Date(totevic4$filed_date), na.rm = TRUE), "%B %d, %Y")` and
`r format(max(as.Date(totevic4$filed_date), na.rm = TRUE), "%B %d, %Y")`,
...
From `r format(min(as.Date(deac$observationDate), na.rm = TRUE), "%B %d, %Y")` through
`r format(max(as.Date(deac$observationDate), na.rm = TRUE), "%B %d, %Y")`, 7 SMU law students and 3 research assistants
