...
**Between
`r format(min(as.Date(totevic4$filed_date), na.rm = TRUE), "%B %d, %Y")`
and
...
`r paste0(chgevic3, "%")` decrease over this same time period in 2023
and a `r paste0(chgevic1, "%")` increase over the same time period in
2022.
