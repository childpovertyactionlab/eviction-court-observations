...
caseAppearDeac <- rbind(defAppearDeac, plaAppearDeac)
...
```{r}
#| fig-height: 4
court_order <- c("Court 1-1", "Court 1-2", "Court 2-1", "Court 2-2","Court 3-1", "Court 3-2" ,"Court 4-2", "Court 5-1", "Court 5-2" ,"Total")
